...
const RESERVED_RUNTIME_TAGS = [
    getenv("SB_DNS_SERVER_TAG") || "dns-server",
    getenv("SB_FAKEIP_DNS_SERVER_TAG") || "fakeip-server",
    getenv("SB_BOOTSTRAP_SERVER_TAG") || "bootstrap-dns-server",
    getenv("SB_FAKEIP_DNS_RULE_TAG") || "fakeip-dns-rule-tag",
    getenv("SB_FAKEIP_RULESET_DNS_RULE_TAG") || "fakeip-ruleset-dns-rule-tag",
    getenv("SB_SERVICE_FAKEIP_DNS_RULE_TAG") || "service-fakeip-dns-rule-tag",
    getenv("SB_TPROXY_INBOUND_TAG") || "tproxy-in",
    getenv("SB_DNS_INBOUND_TAG") || "dns-in",
    getenv("SB_SERVICE_MIXED_INBOUND_TAG") || "service-mixed-in",
    getenv("SB_DIRECT_OUTBOUND_TAG") || "direct-out"
];
